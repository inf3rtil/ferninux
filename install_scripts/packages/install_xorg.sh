...
recipes+=(libraries/wayland-protocols) # for plasma
recipes+=(programming/cmake)
recipes+=(programming/llvm)
recipes+=(programming/mako)
recipes+=(graphical_libraries/libdrm)
recipes+=(multimedia_libraries/libva-pre-mesa)
recipes+=(xorg/Mesa)
recipes+=(multimedia_libraries/libva-post-mesa)
recipes+=(multimedia_libraries/libvdpau)
